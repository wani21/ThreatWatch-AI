...
from sqlalchemy import String, Float, DateTime, ForeignKey, func, UUID, JSON
...
class RiskAssessment(Base):
    ...
    risk_factors: Mapped[Optional[List[str]]] = mapped_column(JSON, nullable=True, default=list)
