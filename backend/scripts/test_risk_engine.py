...
def main():
    print_separator()
    print("      THREATWATCH-AI - RISK SCORING ENGINE VALIDATION SUITE")
    print_separator()
    ...
    try:
        ...
        # 3. Ensure AI Model is Trained (for anomaly scores)
        print("[*] Step 3: Verifying AI Model training status...")
        anomaly_service = AnomalyService(db)
        anomaly_service.ensure_trained()
        print("[+] AI Anomaly Model is trained and active.")
        print_separator("-")

        # 4. Seeding and evaluating scenarios in complete isolation
        print("[*] Step 4: Commencing isolated threat scenarios evaluations...")
        print_separator("-")
        ...
        # ==========================================
        print("Executing Risk Scoring for: Scenario 2: Brute Force Attack")
        ...
        # Trigger event (the 6th failed/success event)
        ...
        # ==========================================
        print("Executing Risk Scoring for: Scenario 3: Night Login")
        ...
        # 2. Login from New York 10 minutes later
